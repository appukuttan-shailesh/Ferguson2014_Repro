...
from Brian1.generic_Pyr_model_Brian1 import CA1_Pyr_Brian1_Template
model = CA1_Pyr_Brian1_Template(type='{model_type}', v_init={v_init})
test.judge(model, deep_error=True)
    """.format(data=data, feature=feature, model_type=model_type, v_init=v_init)
    return commands

print("********************************************************************************")
print("SA Model - Initial FI - Vm=-65.0 mV")
model_type = "strong"
data = data_SA_intial
feature = "initial_fi"
v_init = -65.0
with subprocess.Popen([py2env, "-c", 
...
print("********************************************************************************")
print("SA Model - Final FI - Vm=-65.0 mV")
model_type = "strong"
data = data_SA_final
feature = "final_fi"
v_init = -65.0
...
print("********************************************************************************")
print("WA1 Model - Initial FI - Vm=-65.0 mV")
model_type = "weak1"
...
print("********************************************************************************")
print("WA1 Model - Final FI - Vm=-65.0 mV")
model_type = "weak1"
data = data_WA1_final
feature = "final_fi"
v_init = -65.0
...
print("********************************************************************************")
print("WA2 Model - Initial FI - Vm=-65.0 mV")
model_type = "weak2"
...
print("********************************************************************************")
print("WA2 Model - Final FI - Vm=-65.0 mV")
model_type = "weak2"
data = data_WA2_final
feature = "final_fi"
v_init = -65.0
