...
model = CA1_Pyr_Brian2_Template(type = model_type)
...
if current["amplitude"] > 0:
    filename = "data_Brian2_{}_depol_{}.xlsx".format(model_type, str(current["amplitude"]))
else:
    filename = "data_Brian2_{}_hyperpol_{}.xlsx".format(model_type, str(current["amplitude"]))
