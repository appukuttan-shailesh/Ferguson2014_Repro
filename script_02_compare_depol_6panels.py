...
ax1.text(0.7, 1.125, "Strongly adapting model with 188 pA input", transform=ax1.transAxes, fontsize=14, va='top', ha='center')
...
ax3.text(0.7, 1.125, "Weakly adapting model #1 with 154 pA input", transform=ax3.transAxes, fontsize=14, va='top', ha='center')
...
ax5.text(0.7, 1.125, "Weakly adapting model #2 with 154 pA input", transform=ax5.transAxes, fontsize=14, va='top', ha='center')
...
fig_name = os.path.join(output_directory, "script_02_depol_plot_6panels.pdf")
plt.savefig(fig_name, dpi=600, bbox_inches='tight')
fig_name = os.path.join(output_directory, "script_02_depol_plot_6panels.png")
plt.savefig(fig_name, dpi=600, bbox_inches='tight')
plt.show()